...
public class BarcodeActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_barcode3);


        FloatingActionButton btn = (FloatingActionButton) findViewById(R.id.button3);
